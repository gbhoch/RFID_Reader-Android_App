...
public class DeviceListActivity extends Activity
{
    ...
    {
        super.onPause();
        ReaderManager.sharedInstance().stopDiscovery();
    ...
    protected void onResume()
    {
        ...
        ReaderManager.sharedInstance().startDiscovery();
        ...
        {
            boolean p1 = ContextCompat.checkSelfPermission(this, Manifest.permission.BLUETOOTH) != PackageManager.PERMISSION_GRANTED;
            boolean p2 = ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED;
            isPromptVisible = (p1 || p2);
        }
        else
        {
            boolean p1 = ContextCompat.checkSelfPermission(this, Manifest.permission.BLUETOOTH) != PackageManager.PERMISSION_GRANTED;
            boolean p2 = ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED;
            //boolean p3 = ContextCompat.checkSelfPermission(this, Manifest.permission.BLUETOOTH_ADMIN) != PackageManager.PERMISSION_GRANTED;
            isPromptVisible = (p1 || p2);
        }
    ...
    Observable.Observer<Reader> mAddedObserver = new Observable.Observer<Reader>()
    {
        ...
        public void update(Observable<? extends Reader> observable, Reader reader)
        {
            ...
            mRecyclerView.post(new Runnable() {
                ...
                public void run()
                {
                    if (D) { Log.d(TAG, "Inserting: " + readerIndex); }
                    //ArrayList<Reader> readers = ReaderManager.sharedInstance().getReaderList().list();
