...
public class ReaderViewAdapter extends RecyclerView.Adapter<ReaderViewAdapter.ReaderViewHolder>
{
    ...
    static class ReaderViewHolder extends RecyclerView.ViewHolder
    {
        ...
        void bind(Reader reader, boolean isSelected)
        {
            ...
            boolean isBlePresent = reader.hasTransportOfType(TransportType.BLE);
            boolean isBleActive = reader.hasConnectedTransportOfType(TransportType.BLE);
            ...
            TextView bleTV = mBleTextView;
            bleTV.setVisibility(isBlePresent ? View.VISIBLE : View.INVISIBLE);
            bleTV.setTextColor(isBleActive ? resources.getColor(R.color.dl_transport_on) : resources.getColor(R.color.dl_transport_off));
